...
def get_train_args(
    ...
    if model_args.quantization_bit is not None and (not training_args.do_train):
        print("Evaluating model in 4/8-bit mode may cause lower scores.")

    if training_args.do_train and (not training_args.fp16) and (not training_args.bf16):
        print("We recommend enable mixed precision training.")

    # postprocess data_args
    if data_args.max_samples is not None and data_args.streaming:
        print("`max_samples` is incompatible with `streaming`. Disabling max_samples.")
    ...
    if (
        ...
        print("`ddp_find_unused_parameters` needs to be set as False for LoRA in DDP training.")
    ...
    print("Process rank: {}, device: {}, n_gpu: {}\n  distributed training: {}, compute dtype: {}".format(
